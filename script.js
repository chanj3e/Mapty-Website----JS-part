...
// const run1 = new Running([20, -12], 50, 120, 50);
// const cycling1 = new Cycling([20, -12], 502, 120, 5220);
...
const errCon = document.getElementById('errorContainer');

// // // Application Archetiture
class App {
  #map;
  #mapEvent;
  #zoomMap = 14.5;
  ...
  constructor() {
    ...
    containerWorkouts.addEventListener('click', this._toPopUp.bind(this));
  ...
  showError() {
    errCon.style.visibility = 'visible';
    errCon.style.opacity = '1';
  }

  hideError() {
    errCon.style.opacity = '0';
    setTimeout(() => (errCon.style.visibility = 'hidden'), 500);
  }
  _loadMap(pos) {
